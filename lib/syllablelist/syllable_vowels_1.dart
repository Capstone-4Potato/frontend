...
class SyllableVowels1 extends StatefulWidget {
  const SyllableVowels1({super.key});

  @override
  State<SyllableVowels1> createState() => _SyllableVowels1State();
}

class _SyllableVowels1State extends State<SyllableVowels1> {
  ...
  void initFetch() async {
    var data = await fetchData('음절', '단모음');
    if (data != null) {
      setState(() {
