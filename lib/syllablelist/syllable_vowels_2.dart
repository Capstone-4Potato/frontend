...
class SyllableVowels2 extends StatefulWidget {
  const SyllableVowels2({super.key});

  @override
  State<SyllableVowels2> createState() => _SyllableVowels2State();
}

class _SyllableVowels2State extends State<SyllableVowels2> {
  ...
  void initFetch() async {
    var data = await fetchData('음절', '이중모음1');
    if (data != null) {
      setState(() {
