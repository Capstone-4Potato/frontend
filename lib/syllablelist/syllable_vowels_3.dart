...
class SyllableVowels3 extends StatefulWidget {
  const SyllableVowels3({super.key});

  @override
  State<SyllableVowels3> createState() => _SyllableVowels3State();
}

class _SyllableVowels3State extends State<SyllableVowels3> {
  ...
  void initFetch() async {
    var data = await fetchData('음절', '이중모음2');
    if (data != null) {
      setState(() {
