...
class SyllableConsonants6 extends StatefulWidget {
  const SyllableConsonants6({super.key});

  @override
  State<SyllableConsonants6> createState() => _SyllableConsonants6State();
}

class _SyllableConsonants6State extends State<SyllableConsonants6> {
  ...
  void initFetch() async {
    var data = await fetchData('음절', '자음ㄴㄹㅁ');
    if (data != null) {
      setState(() {
