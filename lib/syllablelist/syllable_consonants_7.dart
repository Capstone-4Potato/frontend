...
class SyllableConsonants7 extends StatefulWidget {
  const SyllableConsonants7({super.key});

  @override
  State<SyllableConsonants7> createState() => _SyllableConsonants7State();
}

class _SyllableConsonants7State extends State<SyllableConsonants7> {
  ...
  void initFetch() async {
    var data = await fetchData('음절', '자음ㅇㅎ');
    if (data != null) {
      setState(() {
