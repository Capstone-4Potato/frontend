...
/// 문장 피드백 UI
class TongueTwistersFeedbackUI extends StatefulWidget {
  final FeedbackData feedbackData;
  final String recordedFilePath;
  String text; // 올바른 발음
  // 필수 매개변수로 피드백 데이터와 녹음된 파일 경로를 받는다
  TongueTwistersFeedbackUI({
    super.key,
  ...
  @override
  State<TongueTwistersFeedbackUI> createState() => _SentenceFeedbackUIState();
}

class _SentenceFeedbackUIState extends State<TongueTwistersFeedbackUI> {
