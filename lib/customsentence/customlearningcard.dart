...
import 'package:flutter_application_1/customsentence/feedback.dart';
...
// Fetch correct audio data
    ...
    String? base64correctAudio = CustomTtsService.instance.base64CorrectAudio;
    //print(base64correctAudio);
    //print(base64userAudio);

    if (base64correctAudio != null) {
      print("base64correctAudio는 널이 아님");
      FeedbackData? feedbackData = await customFeedback(
