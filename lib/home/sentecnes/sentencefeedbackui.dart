...
class SentenceFeedbackUI extends StatefulWidget {
  ...
  @override
  State<SentenceFeedbackUI> createState() => _SentenceFeedbackUIState();
}

class _SentenceFeedbackUIState extends State<SentenceFeedbackUI> {
