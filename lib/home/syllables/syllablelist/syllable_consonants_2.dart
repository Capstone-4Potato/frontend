...
class SyllableConsonants2 extends StatefulWidget {
  const SyllableConsonants2({super.key});

  @override
  State<SyllableConsonants2> createState() => _SyllableConsonants2State();
}

class _SyllableConsonants2State extends State<SyllableConsonants2> {
  ...
  void initFetch() async {
    var data = await fetchData('음절', '자음ㄷㅌㄸ');
    if (data != null) {
      setState(() {
