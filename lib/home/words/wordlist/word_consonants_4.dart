...
class WordConsonants4 extends StatefulWidget {
  const WordConsonants4({super.key});

  @override
  State<WordConsonants4> createState() => _WordConsonants4State();
}

class _WordConsonants4State extends State<WordConsonants4> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '자음ㅅㅆ');
    if (data != null) {
      setState(() {
