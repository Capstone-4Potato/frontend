...
class WordConsonants5 extends StatefulWidget {
  const WordConsonants5({super.key});

  @override
  State<WordConsonants5> createState() => _WordConsonants5State();
}

class _WordConsonants5State extends State<WordConsonants5> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '자음ㅈㅊㅉ');
    if (data != null) {
      setState(() {
