...
class WordVowels3 extends StatefulWidget {
  const WordVowels3({super.key});

  @override
  State<WordVowels3> createState() => _WordVowels3State();
}

class _WordVowels3State extends State<WordVowels3> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '이중모음2');
    if (data != null) {
      setState(() {
