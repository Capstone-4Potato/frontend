...
class WordFinalConsonants6 extends StatefulWidget {
  const WordFinalConsonants6({super.key});

  @override
  State<WordFinalConsonants6> createState() => _WordFinalConsonants6State();
}

class _WordFinalConsonants6State extends State<WordFinalConsonants6> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㅂ');
    if (data != null) {
      setState(() {
