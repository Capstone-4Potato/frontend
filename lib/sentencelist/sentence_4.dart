...
class Sentence4 extends StatefulWidget {
  const Sentence4({super.key});

  @override
  State<Sentence4> createState() => _Sentence4State();
}

class _Sentence4State extends State<Sentence4> {
  ...
  void initFetch() async {
    var data = await fetchData('문장', '자기소개');
    if (data != null) {
      setState(() {
