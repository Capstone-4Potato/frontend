...
class LearningCourseTutorialScreen1 extends StatefulWidget {
  const LearningCourseTutorialScreen1({
    super.key,
  ...
  @override
  State<LearningCourseTutorialScreen1> createState() =>
      _LearningCourseTutorialScreen1State();
}

class _LearningCourseTutorialScreen1State
    extends State<LearningCourseTutorialScreen1> {
