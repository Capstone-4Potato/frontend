...
class WordFinalConsonants3 extends StatefulWidget {
  const WordFinalConsonants3({super.key});

  @override
  State<WordFinalConsonants3> createState() => _WordFinalConsonants3State();
}

class _WordFinalConsonants3State extends State<WordFinalConsonants3> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㄷ');
    if (data != null) {
      setState(() {
