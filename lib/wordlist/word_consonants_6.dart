...
class WordConsonants6 extends StatefulWidget {
  const WordConsonants6({super.key});

  @override
  State<WordConsonants6> createState() => _WordConsonants6State();
}

class _WordConsonants6State extends State<WordConsonants6> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '자음ㄴㄹㅁ');
    if (data != null) {
      setState(() {
