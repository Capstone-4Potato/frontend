...
class WordFinalConsonants5 extends StatefulWidget {
  const WordFinalConsonants5({super.key});

  @override
  State<WordFinalConsonants5> createState() => _WordFinalConsonants5State();
}

class _WordFinalConsonants5State extends State<WordFinalConsonants5> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㅁ');
    if (data != null) {
      setState(() {
