...
class WordFinalConsonants7 extends StatefulWidget {
  const WordFinalConsonants7({super.key});

  @override
  State<WordFinalConsonants7> createState() => _WordFinalConsonants7State();
}

class _WordFinalConsonants7State extends State<WordFinalConsonants7> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㅇ');
    if (data != null) {
      setState(() {
