...
class WordVowels2 extends StatefulWidget {
  const WordVowels2({super.key});

  @override
  State<WordVowels2> createState() => _WordVowels2State();
}

class _WordVowels2State extends State<WordVowels2> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '이중모음1');
    if (data != null) {
      setState(() {
