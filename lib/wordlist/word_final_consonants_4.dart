...
class WordFinalConsonants4 extends StatefulWidget {
  const WordFinalConsonants4({super.key});

  @override
  State<WordFinalConsonants4> createState() => _WordFinalConsonants4State();
}

class _WordFinalConsonants4State extends State<WordFinalConsonants4> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㄹ');
    if (data != null) {
      setState(() {
