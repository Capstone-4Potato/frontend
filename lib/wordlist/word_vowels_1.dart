...
class WordVowels1 extends StatefulWidget {
  const WordVowels1({super.key});

  @override
  State<WordVowels1> createState() => _WordVowels1State();
}

class _WordVowels1State extends State<WordVowels1> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '단모음');
    if (data != null) {
      setState(() {
