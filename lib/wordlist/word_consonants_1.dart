...
class WordConsonants1 extends StatefulWidget {
  const WordConsonants1({super.key});

  @override
  State<WordConsonants1> createState() => _WordConsonants1State();
}

class _WordConsonants1State extends State<WordConsonants1> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '자음ㄱㅋㄲ');
    if (data != null) {
      setState(() {
