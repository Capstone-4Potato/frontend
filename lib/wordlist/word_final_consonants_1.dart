...
class WordFinalConsonants1 extends StatefulWidget {
  const WordFinalConsonants1({super.key});

  @override
  State<WordFinalConsonants1> createState() => _WordFinalConsonants1State();
}

class _WordFinalConsonants1State extends State<WordFinalConsonants1> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㄱ');
    if (data != null) {
      setState(() {
