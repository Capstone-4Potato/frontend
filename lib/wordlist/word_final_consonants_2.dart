...
class WordFinalConsonants2 extends StatefulWidget {
  const WordFinalConsonants2({super.key});

  @override
  State<WordFinalConsonants2> createState() => _WordFinalConsonants2State();
}

class _WordFinalConsonants2State extends State<WordFinalConsonants2> {
  ...
  void initFetch() async {
    var data = await fetchData('단어', '받침ㄴ');
    if (data != null) {
      setState(() {
