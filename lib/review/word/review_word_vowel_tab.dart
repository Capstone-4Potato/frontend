...
import 'package:flutter_application_1/review/word/vowel_1.dart';
import 'package:flutter_application_1/review/word/vowel_2.dart';
import 'package:flutter_application_1/review/word/vowel_3.dart';
...
class _ReviewWordVowelTabState extends State<ReviewWordVowelTab> {
  ...
  Widget _buildWordCard(BuildContext context, String title) {
    final Map<String, Widget Function()> navigationMap = {
      CategoryLists.wordVowels[0]: () => const ReviewWordVowel1(),
      CategoryLists.wordVowels[1]: () => const ReviewWordVowel2(),
      CategoryLists.wordVowels[2]: () => const ReviewWordVowel3(),
    };
