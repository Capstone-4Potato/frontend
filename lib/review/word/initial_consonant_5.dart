...
class ReviewIC5 extends StatefulWidget {
  const ReviewIC5({super.key});

  @override
  State<ReviewIC5> createState() => _ReviewIC5State();
}

class _ReviewIC5State extends State<ReviewIC5> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '자음ㅈㅊㅉ');
