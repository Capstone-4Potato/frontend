...
class ReviewWordVowel3 extends StatefulWidget {
  const ReviewWordVowel3({super.key});

  @override
  State<ReviewWordVowel3> createState() => _ReviewWordVowel3State();
}

class _ReviewWordVowel3State extends State<ReviewWordVowel3> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '이중모음2');
