...
class ReviewWordVowel2 extends StatefulWidget {
  const ReviewWordVowel2({super.key});

  @override
  State<ReviewWordVowel2> createState() => _ReviewWordVowel2State();
}

class _ReviewWordVowel2State extends State<ReviewWordVowel2> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '이중모음1');
