...
class ReviewFC5 extends StatefulWidget {
  const ReviewFC5({super.key});

  @override
  State<ReviewFC5> createState() => _ReviewFC5State();
}

class _ReviewFC5State extends State<ReviewFC5> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '받침ㅁ');
    print(data);
