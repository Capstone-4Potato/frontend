...
class ReviewWordVowel1 extends StatefulWidget {
  const ReviewWordVowel1({super.key});

  @override
  State<ReviewWordVowel1> createState() => _ReviewWordVowel1State();
}

class _ReviewWordVowel1State extends State<ReviewWordVowel1> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '단모음');
