...
class ReviewFC1 extends StatefulWidget {
  const ReviewFC1({super.key});

  @override
  State<ReviewFC1> createState() => _ReviewFC1State();
}

class _ReviewFC1State extends State<ReviewFC1> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '받침ㄱ');
    //print(data);
