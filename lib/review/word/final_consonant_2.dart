...
class ReviewFC2 extends StatefulWidget {
  const ReviewFC2({super.key});

  @override
  State<ReviewFC2> createState() => _ReviewFC2State();
}

class _ReviewFC2State extends State<ReviewFC2> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '받침ㄴ');
    print(data);
