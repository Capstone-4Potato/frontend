...
class ReviewFC7 extends StatefulWidget {
  const ReviewFC7({super.key});

  @override
  State<ReviewFC7> createState() => _ReviewFC7State();
}

class _ReviewFC7State extends State<ReviewFC7> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '받침ㅇ');
    //print(data);
