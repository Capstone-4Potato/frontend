...
class ReviewIC2 extends StatefulWidget {
  const ReviewIC2({super.key});

  @override
  State<ReviewIC2> createState() => _ReviewIC2State();
}

class _ReviewIC2State extends State<ReviewIC2> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '자음ㄷㅌㄸ');
