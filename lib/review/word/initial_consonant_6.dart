...
class ReviewIC6 extends StatefulWidget {
  const ReviewIC6({super.key});

  @override
  State<ReviewIC6> createState() => _ReviewIC6State();
}

class _ReviewIC6State extends State<ReviewIC6> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '자음ㄴㄹㅁ');
