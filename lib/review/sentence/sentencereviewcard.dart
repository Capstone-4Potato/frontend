...
class ReviewSentenceCard extends StatefulWidget {
  ...
  @override
  State<ReviewSentenceCard> createState() => _ReviewSentenceCardState();
}

class _ReviewSentenceCardState extends State<ReviewSentenceCard> {
