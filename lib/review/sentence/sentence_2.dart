...
class ReviewSentence2 extends StatefulWidget {
  const ReviewSentence2({super.key});

  @override
  State<ReviewSentence2> createState() => _ReviewSentence2State();
}

class _ReviewSentence2State extends State<ReviewSentence2> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('문장', '학교대화');
    print(data);
