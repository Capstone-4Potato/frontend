...
class ReviewConsonant2 extends StatefulWidget {
  const ReviewConsonant2({super.key});

  @override
  State<ReviewConsonant2> createState() => _ReviewConsonant2State();
}

class _ReviewConsonant2State extends State<ReviewConsonant2> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㄷㅌㄸ');
