...
class ReviewConsonant5 extends StatefulWidget {
  const ReviewConsonant5({super.key});

  @override
  State<ReviewConsonant5> createState() => _ReviewConsonant5State();
}

class _ReviewConsonant5State extends State<ReviewConsonant5> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㅈㅊㅉ');
