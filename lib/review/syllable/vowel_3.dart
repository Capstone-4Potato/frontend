...
class ReviewVowel3 extends StatefulWidget {
  const ReviewVowel3({super.key});

  @override
  State<ReviewVowel3> createState() => _ReviewVowel3State();
}

class _ReviewVowel3State extends State<ReviewVowel3> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '이중모음2');
