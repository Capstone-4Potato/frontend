...
class ReviewConsonant7 extends StatefulWidget {
  const ReviewConsonant7({super.key});

  @override
  State<ReviewConsonant7> createState() => _ReviewConsonant7State();
}

class _ReviewConsonant7State extends State<ReviewConsonant7> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㅇㅎ');
