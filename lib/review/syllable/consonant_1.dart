...
class ReviewConsonant1 extends StatefulWidget {
  const ReviewConsonant1({super.key});

  @override
  State<ReviewConsonant1> createState() => _ReviewConsonant1State();
}

class _ReviewConsonant1State extends State<ReviewConsonant1> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㄱㅋㄲ');
