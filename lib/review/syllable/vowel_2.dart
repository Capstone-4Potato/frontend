...
class ReviewVowel2 extends StatefulWidget {
  const ReviewVowel2({super.key});

  @override
  State<ReviewVowel2> createState() => _ReviewVowel2State();
}

class _ReviewVowel2State extends State<ReviewVowel2> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '이중모음1');
