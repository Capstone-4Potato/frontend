...
class ReviewConsonant3 extends StatefulWidget {
  const ReviewConsonant3({super.key});

  @override
  State<ReviewConsonant3> createState() => _ReviewConsonant3State();
}

class _ReviewConsonant3State extends State<ReviewConsonant3> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㅂㅍㅃ');
