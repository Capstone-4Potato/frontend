...
class ReviewConsonant4 extends StatefulWidget {
  const ReviewConsonant4({super.key});

  @override
  State<ReviewConsonant4> createState() => _ReviewConsonant4State();
}

class _ReviewConsonant4State extends State<ReviewConsonant4> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㅅㅆ');
