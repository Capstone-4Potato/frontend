...
class ReviewConsonant6 extends StatefulWidget {
  const ReviewConsonant6({super.key});

  @override
  State<ReviewConsonant6> createState() => _ReviewConsonant6State();
}

class _ReviewConsonant6State extends State<ReviewConsonant6> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '자음ㄴㄹㅁ');
