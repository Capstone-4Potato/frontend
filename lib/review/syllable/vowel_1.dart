...
class ReviewVowel1 extends StatefulWidget {
  const ReviewVowel1({super.key});

  @override
  State<ReviewVowel1> createState() => _ReviewVowel1State();
}

class _ReviewVowel1State extends State<ReviewVowel1> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('음절', '단모음');
