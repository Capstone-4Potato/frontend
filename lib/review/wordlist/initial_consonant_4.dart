...
class ReviewIC4 extends StatefulWidget {
  const ReviewIC4({super.key});

  @override
  State<ReviewIC4> createState() => _ReviewIC4State();
}

class _ReviewIC4State extends State<ReviewIC4> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '자음ㅅㅆ');
