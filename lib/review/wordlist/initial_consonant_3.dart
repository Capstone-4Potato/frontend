...
class ReviewIC3 extends StatefulWidget {
  const ReviewIC3({super.key});

  @override
  State<ReviewIC3> createState() => _ReviewIC3State();
}

class _ReviewIC3State extends State<ReviewIC3> {
  ...
  void initFetch() async {
    var data = await fetchReviewList('단어', '자음ㅂㅍㅃ');
